...
export class WebhookApiStack extends TaggedStack {
  ...
  constructor(scope: Construct, id: string, props: WebhookApiStackProps) {
    ...
    const smartContractEventHandler = new NodejsFunction(this, 'SmartContractEventHandler', {
      ...
      entry: path.join(__dirname, '../src/smartContractEventProcessor/smartContractEventProcessor.ts'),
    ...
    smartContractEventHandler.addEventSource(new SqsEventSource(this.smartContractEventQueue))
  }
}
