...
describe('SecretClient', () => {
  ...
  it('should load plaintext secret', async () => {
    ...
    const response = await secretClient.loadPlainTextSecretValue('my-secret-name')
  ...
  it('should load json secret', async () => {
    ...
    const response = await secretClient.loadJsonSecretValue<{ value: string }>('my-secret-name')
